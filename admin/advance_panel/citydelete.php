...
?>
<form name="fcitydelete" id="fcitydelete" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($city->id->Visible) { // id ?>
		<td><span id="elh_city_id" class="city_id"><?php echo $city->id->FldCaption() ?></span></td>
<?php } ?>
...
<span id="el<?php echo $city_delete->RowCnt ?>_city_id" class="control-group city_id">
...
<span id="el<?php echo $city_delete->RowCnt ?>_city_name" class="control-group city_name">
...
<span id="el<?php echo $city_delete->RowCnt ?>_city_province" class="control-group city_province">
