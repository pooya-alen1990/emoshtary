...
// Page object
var sub_category_add = new ew_Page("sub_category_add");
sub_category_add.PageID = "add"; // Page ID
var EW_PAGE_ID = sub_category_add.PageID; // For backward compatibility

// Form object
var fsub_categoryadd = new ew_Form("fsub_categoryadd");
...
?>
<form name="fsub_categoryadd" id="fsub_categoryadd" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="sub_category">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_sub_categoryadd" class="table table-bordered table-striped">
