...
// Page object
var sub_category_edit = new ew_Page("sub_category_edit");
sub_category_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = sub_category_edit.PageID; // For backward compatibility

// Form object
var fsub_categoryedit = new ew_Form("fsub_categoryedit");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_HasValue(elm))
				return this.OnError(elm, ewLanguage.Phrase("EnterRequiredField") + " - <?php echo ew_JsEncode2($sub_category->name->FldCaption()) ?>");
			elm = this.GetElements("x" + infix + "_category_id");
			if (elm && !ew_HasValue(elm))
				return this.OnError(elm, ewLanguage.Phrase("EnterRequiredField") + " - <?php echo ew_JsEncode2($sub_category->category_id->FldCaption()) ?>");
			elm = this.GetElements("x" + infix + "_category_id");
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($sub_category->category_id->FldErrMsg()) ?>");
...
?>
<form name="fsub_categoryedit" id="fsub_categoryedit" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="sub_category">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table class="ewGrid"><tr><td>
<table id="tbl_sub_categoryedit" class="table table-bordered table-striped">
<?php if ($sub_category->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_sub_category_id"><?php echo $sub_category->id->FldCaption() ?></span></td>
		<td<?php echo $sub_category->id->CellAttributes() ?>>
<span id="el_sub_category_id" class="control-group">
<span<?php echo $sub_category->id->ViewAttributes() ?>>
<?php echo $sub_category->id->EditValue ?></span>
</span>
<input type="hidden" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($sub_category->id->CurrentValue) ?>">
<?php echo $sub_category->id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($sub_category->name->Visible) { // name ?>
	<tr id="r_name">
		<td><span id="elh_sub_category_name"><?php echo $sub_category->name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $sub_category->name->CellAttributes() ?>>
<span id="el_sub_category_name" class="control-group">
<input type="text" data-field="x_name" name="x_name" id="x_name" size="30" maxlength="250" placeholder="<?php echo ew_HtmlEncode($sub_category->name->PlaceHolder) ?>" value="<?php echo $sub_category->name->EditValue ?>"<?php echo $sub_category->name->EditAttributes() ?>>
</span>
<?php echo $sub_category->name->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($sub_category->category_id->Visible) { // category_id ?>
	<tr id="r_category_id">
		<td><span id="elh_sub_category_category_id"><?php echo $sub_category->category_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $sub_category->category_id->CellAttributes() ?>>
<span id="el_sub_category_category_id" class="control-group">
<input type="text" data-field="x_category_id" name="x_category_id" id="x_category_id" size="30" placeholder="<?php echo ew_HtmlEncode($sub_category->category_id->PlaceHolder) ?>" value="<?php echo $sub_category->category_id->EditValue ?>"<?php echo $sub_category->category_id->EditAttributes() ?>>
</span>
<?php echo $sub_category->category_id->CustomMsg ?></td>
	</tr>
<?php } ?>
</table>
</td></tr></table>
