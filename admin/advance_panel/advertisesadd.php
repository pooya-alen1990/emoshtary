...
$advertises_add = NULL; // Initialize page object first

class cadvertises_add extends cadvertises {
	...
	// Page object name
	var $PageObjName = 'advertises_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "advertisesview.php")
	...
	function LoadDefaultValues() {
		...
		$this->sub_cat_id->CurrentValue = NULL;
		$this->sub_cat_id->OldValue = $this->sub_cat_id->CurrentValue;
		$this->slogan->CurrentValue = NULL;
		$this->slogan->OldValue = $this->slogan->CurrentValue;
		...
		$this->google_map->CurrentValue = NULL;
		$this->google_map->OldValue = $this->google_map->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// sub_cat_id
		$this->sub_cat_id->SetDbValueDef($rsnew, $this->sub_cat_id->CurrentValue, 0, FALSE);

		// slogan
		$this->slogan->SetDbValueDef($rsnew, $this->slogan->CurrentValue, "", FALSE);
		...
		// keywords
		$this->keywords->SetDbValueDef($rsnew, $this->keywords->CurrentValue, "", FALSE);

		// register_date
		$this->register_date->SetDbValueDef($rsnew, $this->register_date->CurrentValue, 0, FALSE);

		// google_map
		$this->google_map->SetDbValueDef($rsnew, $this->google_map->CurrentValue, "", FALSE);
		...
		// image
		$this->image->SetDbValueDef($rsnew, $this->image->CurrentValue, 0, FALSE);
...
// Create page object
if (!isset($advertises_add)) $advertises_add = new cadvertises_add();

// Page init
$advertises_add->Page_Init();

// Page main
$advertises_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$advertises_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var advertises_add = new ew_Page("advertises_add");
advertises_add.PageID = "add"; // Page ID
var EW_PAGE_ID = advertises_add.PageID; // For backward compatibility

// Form object
var fadvertisesadd = new ew_Form("fadvertisesadd");

// Validate form
fadvertisesadd.Validate = function() {
...
fadvertisesadd.Form_CustomValidate = 
...
fadvertisesadd.ValidateRequired = true;
<?php } else { ?>
fadvertisesadd.ValidateRequired = false; 
<?php } ?>
...
<?php $advertises_add->ShowPageHeader(); ?>
<?php
$advertises_add->ShowMessage();
?>
<form name="fadvertisesadd" id="fadvertisesadd" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="advertises">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_advertisesadd" class="table table-bordered table-striped">
