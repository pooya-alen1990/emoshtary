...
?>
<form name="fcategorydelete" id="fcategorydelete" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<table id="tbl_categorydelete" class="ewTable ewTableSeparate">
<?php echo $category->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
<?php if ($category->id->Visible) { // id ?>
		<td><span id="elh_category_id" class="category_id"><?php echo $category->id->FldCaption() ?></span></td>
<?php } ?>
<?php if ($category->name->Visible) { // name ?>
		<td><span id="elh_category_name" class="category_name"><?php echo $category->name->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $category_delete->RowCnt ?>_category_id" class="control-group category_id">
...
<span id="el<?php echo $category_delete->RowCnt ?>_category_name" class="control-group category_name">
