...
?>
<form name="fcategoryadd" id="fcategoryadd" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="category">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_categoryadd" class="table table-bordered table-striped">
