	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_HasValue(elm))
				return this.OnError(elm, ewLanguage.Phrase("EnterRequiredField") + " - <?php echo ew_JsEncode2($category->name->FldCaption()) ?>");
...
?>
<form name="fcategoryedit" id="fcategoryedit" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="category">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table class="ewGrid"><tr><td>
<table id="tbl_categoryedit" class="table table-bordered table-striped">
<?php if ($category->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_category_id"><?php echo $category->id->FldCaption() ?></span></td>
		<td<?php echo $category->id->CellAttributes() ?>>
<span id="el_category_id" class="control-group">
<span<?php echo $category->id->ViewAttributes() ?>>
<?php echo $category->id->EditValue ?></span>
</span>
<input type="hidden" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($category->id->CurrentValue) ?>">
<?php echo $category->id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($category->name->Visible) { // name ?>
	<tr id="r_name">
		<td><span id="elh_category_name"><?php echo $category->name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $category->name->CellAttributes() ?>>
<span id="el_category_name" class="control-group">
<input type="text" data-field="x_name" name="x_name" id="x_name" size="30" maxlength="250" placeholder="<?php echo ew_HtmlEncode($category->name->PlaceHolder) ?>" value="<?php echo $category->name->EditValue ?>"<?php echo $category->name->EditAttributes() ?>>
</span>
<?php echo $category->name->CustomMsg ?></td>
	</tr>
<?php } ?>
</table>
</td></tr></table>
