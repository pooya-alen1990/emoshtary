...
class cimages_view extends cimages {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_images\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_images',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fimagesview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
// Form object
var fimagesview = new ew_Form("fimagesview");
...
<?php if (!$images_view->ExportOptions->UseDropDownButton) { ?>
</div>
...
?>
<form name="fimagesview" id="fimagesview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="images">
<table class="ewGrid"><tr><td>
<table id="tbl_imagesview" class="table table-bordered table-striped">
...
<?php echo $images->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($images->original_image->Visible) { // original_image ?>
	<tr id="r_original_image">
		<td><span id="elh_images_original_image"><?php echo $images->original_image->FldCaption() ?></span></td>
...
<?php echo $images->original_image->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($images->thumbnail_image->Visible) { // thumbnail_image ?>
	<tr id="r_thumbnail_image">
		<td><span id="elh_images_thumbnail_image"><?php echo $images->thumbnail_image->FldCaption() ?></span></td>
...
<?php echo $images->thumbnail_image->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($images->ip_address->Visible) { // ip_address ?>
	<tr id="r_ip_address">
		<td><span id="elh_images_ip_address"><?php echo $images->ip_address->FldCaption() ?></span></td>
...
<?php echo $images->ip_address->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($images->advertise_id->Visible) { // advertise_id ?>
	<tr id="r_advertise_id">
		<td><span id="elh_images_advertise_id"><?php echo $images->advertise_id->FldCaption() ?></span></td>
...
<?php echo $images->advertise_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
