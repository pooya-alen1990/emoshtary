...
$admins_view = NULL; // Initialize page object first

class cadmins_view extends cadmins {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "adminslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "adminslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "adminslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_admins\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_admins',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fadminsview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($admins_view)) $admins_view = new cadmins_view();
...
fadminsview.ValidateRequired = true;
<?php } else { ?>
fadminsview.ValidateRequired = false; 
<?php } ?>
...
<?php $admins_view->ExportOptions->Render("body") ?>
<?php if (!$admins_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($admins_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $admins_view->ShowPageHeader(); ?>
<?php
$admins_view->ShowMessage();
?>
<form name="fadminsview" id="fadminsview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php echo $admins->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($admins->first_name->Visible) { // first_name ?>
	<tr id="r_first_name">
		<td><span id="elh_admins_first_name"><?php echo $admins->first_name->FldCaption() ?></span></td>
...
<?php echo $admins->first_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($admins->last_name->Visible) { // last_name ?>
	<tr id="r_last_name">
		<td><span id="elh_admins_last_name"><?php echo $admins->last_name->FldCaption() ?></span></td>
...
<?php echo $admins->last_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($admins->password->Visible) { // password ?>
	<tr id="r_password">
		<td><span id="elh_admins_password"><?php echo $admins->password->FldCaption() ?></span></td>
...
<?php echo $admins->password->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($admins->mobile->Visible) { // mobile ?>
	<tr id="r_mobile">
		<td><span id="elh_admins_mobile"><?php echo $admins->mobile->FldCaption() ?></span></td>
...
<?php echo $admins->mobile->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($admins->roles_id->Visible) { // roles_id ?>
	<tr id="r_roles_id">
		<td><span id="elh_admins_roles_id"><?php echo $admins->roles_id->FldCaption() ?></span></td>
...
<?php echo $admins->roles_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
