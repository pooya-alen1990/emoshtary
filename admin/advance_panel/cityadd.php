...
class ccity_add extends ccity {
	...
	function AddRow($rsold = NULL) {
		...
		// province
		$this->province->SetDbValueDef($rsnew, $this->province->CurrentValue, 0, FALSE);
...
?>
<form name="fcityadd" id="fcityadd" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
