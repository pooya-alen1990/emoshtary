...
<?php if ($users->activation_code->Visible) { // activation_code ?>
	<tr id="r_activation_code">
		<td><span id="elh_users_activation_code"><?php echo $users->activation_code->FldCaption() ?></span></td>
...
<?php echo $users->activation_code->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($users->asiatech_code->Visible) { // asiatech_code ?>
	<tr id="r_asiatech_code">
		<td><span id="elh_users_asiatech_code"><?php echo $users->asiatech_code->FldCaption() ?></span></td>
...
<?php echo $users->asiatech_code->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($users->melli_code->Visible) { // melli_code ?>
	<tr id="r_melli_code">
		<td><span id="elh_users_melli_code"><?php echo $users->melli_code->FldCaption() ?></span></td>
...
<?php echo $users->melli_code->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($users->mobile->Visible) { // mobile ?>
	<tr id="r_mobile">
		<td><span id="elh_users_mobile"><?php echo $users->mobile->FldCaption() ?></span></td>
...
<?php if ($users->city_id->Visible) { // city_id ?>
	<tr id="r_city_id">
		<td><span id="elh_users_city_id"><?php echo $users->city_id->FldCaption() ?></span></td>
...
<?php echo $users->city_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($users->province_id->Visible) { // province_id ?>
	<tr id="r_province_id">
		<td><span id="elh_users_province_id"><?php echo $users->province_id->FldCaption() ?></span></td>
...
<?php echo $users->province_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($users->address->Visible) { // address ?>
	<tr id="r_address">
		<td><span id="elh_users_address"><?php echo $users->address->FldCaption() ?></span></td>
...
<?php echo $users->address->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($users->register_date->Visible) { // register_date ?>
	<tr id="r_register_date">
		<td><span id="elh_users_register_date"><?php echo $users->register_date->FldCaption() ?></span></td>
...
<?php echo $users->register_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
