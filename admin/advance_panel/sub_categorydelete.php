...
// Page object
var sub_category_delete = new ew_Page("sub_category_delete");
sub_category_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = sub_category_delete.PageID; // For backward compatibility

// Form object
var fsub_categorydelete = new ew_Form("fsub_categorydelete");
...
?>
<form name="fsub_categorydelete" id="fsub_categorydelete" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<table id="tbl_sub_categorydelete" class="ewTable ewTableSeparate">
<?php echo $sub_category->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
<?php if ($sub_category->id->Visible) { // id ?>
		<td><span id="elh_sub_category_id" class="sub_category_id"><?php echo $sub_category->id->FldCaption() ?></span></td>
<?php } ?>
<?php if ($sub_category->name->Visible) { // name ?>
		<td><span id="elh_sub_category_name" class="sub_category_name"><?php echo $sub_category->name->FldCaption() ?></span></td>
<?php } ?>
<?php if ($sub_category->category_id->Visible) { // category_id ?>
		<td><span id="elh_sub_category_category_id" class="sub_category_category_id"><?php echo $sub_category->category_id->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $sub_category_delete->RowCnt ?>_sub_category_id" class="control-group sub_category_id">
...
<span id="el<?php echo $sub_category_delete->RowCnt ?>_sub_category_name" class="control-group sub_category_name">
...
<span id="el<?php echo $sub_category_delete->RowCnt ?>_sub_category_category_id" class="control-group sub_category_category_id">
