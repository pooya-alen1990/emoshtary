...
class cusers extends cTable {
	...
	function __construct() {
		...
		// activation_code
		$this->activation_code = new cField('users', 'users', 'x_activation_code', 'activation_code', '`activation_code`', '`activation_code`', 200, -1, FALSE, '`activation_code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['activation_code'] = &$this->activation_code;

		// asiatech_code
		$this->asiatech_code = new cField('users', 'users', 'x_asiatech_code', 'asiatech_code', '`asiatech_code`', '`asiatech_code`', 200, -1, FALSE, '`asiatech_code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// melli_code
		$this->melli_code = new cField('users', 'users', 'x_melli_code', 'melli_code', '`melli_code`', '`melli_code`', 200, -1, FALSE, '`melli_code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// mobile
		$this->mobile = new cField('users', 'users', 'x_mobile', 'mobile', '`mobile`', '`mobile`', 200, -1, FALSE, '`mobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mobile'] = &$this->mobile;

		// city_id
		$this->city_id = new cField('users', 'users', 'x_city_id', 'city_id', '`city_id`', '`city_id`', 3, -1, FALSE, '`city_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->city_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['city_id'] = &$this->city_id;

		// province_id
		$this->province_id = new cField('users', 'users', 'x_province_id', 'province_id', '`province_id`', '`province_id`', 3, -1, FALSE, '`province_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->province_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['province_id'] = &$this->province_id;

		// address
		$this->address = new cField('users', 'users', 'x_address', 'address', '`address`', '`address`', 201, -1, FALSE, '`address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// register_date
		$this->register_date = new cField('users', 'users', 'x_register_date', 'register_date', '`register_date`', '`register_date`', 20, -1, FALSE, '`register_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
