...
class ccategory_view extends ccategory {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_category\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_category',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fcategoryview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
// Form object
var fcategoryview = new ew_Form("fcategoryview");
...
<?php if (!$category_view->ExportOptions->UseDropDownButton) { ?>
</div>
...
?>
<form name="fcategoryview" id="fcategoryview" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="category">
<table class="ewGrid"><tr><td>
<table id="tbl_categoryview" class="table table-bordered table-striped">
...
<?php echo $category->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($category->name->Visible) { // name ?>
	<tr id="r_name">
		<td><span id="elh_category_name"><?php echo $category->name->FldCaption() ?></span></td>
...
<?php echo $category->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
